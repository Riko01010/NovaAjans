...
export const metadata = {
  title: 'Geleceğin AI Kullanarak Oluşturulan Yazılımları - NOVA AJANS',
  description: 'Yapay zeka teknolojilerinin yazılım geliştirme süreçlerini nasıl dönüştürdüğünü ve geleceğin yazılım dünyasını nasıl şekillendireceğini keşfedin.',
};
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-12 pt-24 max-w-4xl">
        ...
        <article className="prose lg:prose-xl max-w-none">
          <h1 className="text-4xl font-bold mb-6">Geleceğin AI Kullanarak Oluşturulan Yazılımları</h1>
          ...
          <div className="relative h-80 w-full mb-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
            <span className="text-white text-3xl font-bold">AI & Yazılım Geleceği</span>
          </div>
          ...
          <p>
            Geleceğin yazılım teknolojileriyle işletmenizi nasıl güçlendirebileceğinizi öğrenmek için 
            bizimle iletişime geçin. WhatsApp numaramız +90 555 520 3451 veya email adresimiz info@novaajans.ai 
