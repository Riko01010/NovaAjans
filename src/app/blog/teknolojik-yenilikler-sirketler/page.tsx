...
export const metadata = {
  title: 'Teknolojik Yenilikleri Yakalayan Şirketlerin Geleceği - NOVA AJANS',
  description: 'Teknolojik dönüşüme ayak uyduran şirketlerin rekabet avantajı ve gelecekte nasıl öne çıkacakları hakkında detaylı bir analiz.',
};
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-12 pt-24 max-w-4xl">
        ...
        <article className="prose lg:prose-xl max-w-none">
          <h1 className="text-4xl font-bold mb-6">Teknolojik Yenilikleri Yakalayan Şirketlerin Geleceği</h1>
          ...
          <div className="relative h-80 w-full mb-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
            <span className="text-white text-3xl font-bold">Teknolojik Dönüşüm & İş Dünyası</span>
          </div>
          ...
          <p>
            İşletmenizin teknolojik dönüşümünü nasıl hızlandırabileceğinizi öğrenmek için bizimle iletişime 
