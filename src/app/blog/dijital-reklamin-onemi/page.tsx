...
export const metadata = {
  title: 'Dijital Reklamın Önemi ve Etkili Stratejiler - NOVA AJANS',
  description: 'Modern iş dünyasında dijital reklamın kritik rolü ve markanızı öne çıkaracak etkili dijital reklam stratejileri.',
};
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-12 pt-24 max-w-4xl">
        ...
        <article className="prose lg:prose-xl max-w-none">
          <h1 className="text-4xl font-bold mb-6">Dijital Reklamın Önemi ve Etkili Stratejiler</h1>
          
          <div className="text-gray-500 mb-8">
            <span>29 Haziran 2024</span>
            <span className="mx-2">•</span>
            <span>NOVA AJANS</span>
          </div>
          
          <div className="relative h-80 w-full mb-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
            <span className="text-white text-3xl font-bold">Dijital Reklam & Pazarlama</span>
          </div>
          ...
          <h3>1. Arama Motoru Reklamları (SEM)</h3>
          ...
          <h3>2. Sosyal Medya Reklamları</h3>
          ...
          <h3>5. E-posta Pazarlaması</h3>
          
          <p>
            Doğrudan müşterilerinizle iletişim kurmanın en etkili yollarından biri olan e-posta pazarlaması, 
            kişiselleştirilmiş içerik ve teklifler sunmanıza olanak tanır.
          </p>
          
          <h3>6. Influencer Pazarlaması</h3>
          
          <p>
            Sosyal medya fenomenleri aracılığıyla ürün veya hizmetlerinizi tanıtmak, hedef kitlenizle güven 
            oluşturmanın ve organik erişim sağlamanın etkili bir yoludur.
          </p>
          ...
          <p>
            İşletmeniz için en uygun dijital reklam stratejisini belirlemek ve uygulamak için bizimle iletişime 
            geçin. WhatsApp numaramız +90 555 520 3451 veya email adresimiz info@novaajans.ai üzerinden 
          ...
          <div className="mt-12 p-6 bg-gray-100 rounded-lg">
            ...
            <div className="flex space-x-4">
              <button className="bg-blue-600 text-white px-4 py-2 rounded-md">Facebook'ta Paylaş</button>
              <button className="bg-blue-400 text-white px-4 py-2 rounded-md">Twitter'da Paylaş</button>
              <button className="bg-green-500 text-white px-4 py-2 rounded-md">WhatsApp'ta Paylaş</button>
            </div>
          </div>
        </article>
      </div>
