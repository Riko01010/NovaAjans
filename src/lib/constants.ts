// NOVA AI Asistanı için sistem promptu
export const NOVA_SYSTEM_PROMPT = `Sen NOVA AJANS'ın dijital asistanısın. Ajansımız hakkında aşağıdaki bilgileri kullanarak müşterilere yardımcı olmalısın:
